...
<head>
  ...
  <title>Dashboard | Desa Langkat</title>
...
<body class="hold-transition sidebar-mini">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="#" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Desa Langkat</span>
    </a>
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="#" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>
                    Post Berita Informasi Penduduk
                    <i class="right fas fa-angle-left"></i>
                  </p>
                </a>
                <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="index.php?page=tampil-penghasilan" class="nav-link">
                      <i class="far fa-dot-circle nav-icon"></i>
                      <p>Data Penghasilan</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="index.php?page=tambah-penghasilan" class="nav-link">
                      <i class="far fa-dot-circle nav-icon"></i>
              ...
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="index.php?page=tampil-wisata" class="nav-link">
                      <i class="far fa-dot-circle nav-icon"></i>
                      <p>Data Wisata</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="index.php?page=tambah-wisata" class="nav-link">
                      <i class="far fa-dot-circle nav-icon"></i>
                      <p>Tambah Wisata</p>
                    </a>
                  </li>
